select(2, ...).locals = {
	...
	["Unable to restore macros, you already have %d global and %d per character ones created."] = "Unable to restore macros, you already have %d global and %d per character ones created.",
